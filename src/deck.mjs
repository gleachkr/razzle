...
katexStyle.setAttribute("href", "https://cdn.jsdelivr.net/npm/katex@0.16.8/dist/katex.min.css")
katexStyle.setAttribute("rel", "stylesheet")
katexStyle.setAttribute("crossorigin", "anonymous")
katexStyle.setAttribute("integrity", "sha384-GvrOXuhMATgEsSwCs4smul74iXGOixntILdUW9XmUC6+HX0sLNAK3q71HotJqlAn")
...
class RazzleDeck extends HTMLElement {
  ...
  connectedCallback() {
    ...
    const kclone = katexStyle.cloneNode()
    ...
    [...children].map(child => {
      ...
      // We get both math elements in text delimited by `\( \)`, via
      // `renderMathInElement`, and spans with the class "math", of the kind
      // generated by pandoc.
      const mathElements = child.getElementsByClassName("math");
      for (var i = 0; i < mathElements.length; i++) {
        const texText = mathElements[i].firstChild;
        if (mathElements[i].tagName == "SPAN") {
          console.log(mathElements[i], texText.data)
